...
Ta dość duża swoboda interpretacji przepisów jest spowodowana między innymi tym, że \textit{Labirynt śmierci} należy do tego typu gier, w których niemożliwością jest sztywne ujęcie zasadami wszystkich sytuacji, jakie mogą się pojawić w toku rozgrywki. W sytuacjach niejasnych i nie wyjaśnionych w instrukcji należy kierować się po prostu zdrowym rozsądkiem lub (jeśli ktoś woli) rzutem kostką.

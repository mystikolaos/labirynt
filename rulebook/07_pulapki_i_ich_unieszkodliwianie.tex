\section{7.0 PUŁAPKI I ICH UNIESZKODLIWIANIE}
...
Pułapka może być unieszkodliwiona przed przez postać, posiadającą odpowiednie zdolności (,,pułapki'').

Jeżeli próba unieszkodliwienia nie powiedzie się lub nie zostanie podjęta należy rzucić 1K6 i w tabeli 7.1 ,,Pułapki'' sprawdzić rodzaj założonej w danych drzwiach lub skrzymi pułapki.
...
Jeżeli wyrzucona liczba oczek jest niższa lub równa poziomowi zdolności pułapka została szczęśliwie unieszkodliwiona, jeżeli wyżej – pułapka zadziałała.

Uwaga!
Postacie, które nie posiadają odpowiednich zdolności wpadają w pułapki spo-
...
W ten sposób teoretyczna liczba pułapek może być nieskończona.

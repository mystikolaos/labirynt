...
\subsection{Żetony}
346 załączonych do gry żetonów reprezentuje: korytarze, komnaty (puste lub zawierające znaleziska), postacie, które tworzą oddział oraz potwory.
Dołączonych jest również 6 żetonów, zastępujących kostkę.
Przykłady:

[OBRAZEK: PRZYKŁADOWE ŻETONY]

\subsection{Modyfikacje zasad}
Zasady gry są tak skonstruowane, by umożliwić graczom ich dowolną modyfikację oraz/lub formułowanie własnych, nie występujących w instrukcji przepisów.

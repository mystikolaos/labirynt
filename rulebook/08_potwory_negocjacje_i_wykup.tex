...
Jeżeli rzut kostką wskazuje, że nastąpiło spotkanie z potworem należy sprawdzić jego rodzaj w odpowiedniej do typu potwora (osiadły lub wędrowny) tabeli.
...
tabela ,,Charakterystyka potworów''~-- patrz plansza z tabelami.

tabele: ,,Potwory osiadłe'', ,,Potwory wędrowne''~-- patrz plansza z tabelami.

Gracze mogą podjąć próbę negocjacji z każdym potworem z wyjątkiem Bezimiennego i Demonów.

\subsection{Negocjacje}
...
Tabela ,,Negocjacje''~-- patrz plansza z tabelami.

W tabeli 8.5 umieszczone są trzy możliwe rezultaty negocjacji:
...
Jeżeli negocjacje zawiodą oddział może usiłować kupić wolność, ofiarowując potworowi (nie dotyczy to Bezimiennego i Demonów) określoną sumę sztuk złota.
Sprawdzenie czy wykup został przyjęty przebiega następująco:

\begin{enumerate}
    \item
        oblicza się sumę współczynników siła i niechęć do negocjacji najsilniejszego potwora w grupie,
    \item
        przeznacza się określoną sumę sztuk złota jako wykup,
    \item
        w tabeli 8.9 ,,Wykup'' na przecięciu kolumny, odpowiadającej obliczonej w punkcie a. sumie oraz rzędu, odpowiadającego ofiarowanej liczbie sztuk złota odnajdowana jest cyfra od 0 do 6,
    \item
        jeden z graczy rzuca 1K6 i porównuje wyrzuconą liczbę oczek z odczytaną w punkcie c. cyfrą.
...
Wobec każdego potwora lub grupy potworów, bez względu na jej liczebność, może być podjęta tylko jedna próba wykupu.

tabela ,,Wykup''~-- patrz plansza z tabelami.

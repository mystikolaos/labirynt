\section{5.0 PRZEBIEG GRY}

Ogólna zasada:

Gra ,,Labirynt śmierci'' polega na wykonywaniu przez graczy określonych czynności.
Jej celem jest odnalezienie przez oddział i zniszczenie magicznych Czarnych Wrót.

Decyzje, dotyczące zachowania się postaci podczas gry mogą być podejmowane wspólnie przez wszystkich graczy lub też, jeżeli tak zostanie zadecydowane, każdy z graczy może podejmować decyzje indywidualnie.
...
Czynności te muszą być wykonywane w przepisanej im niżej kolejności:
...
Nowy segment musi zostać ułożony tak, by pasował do segmentu opuszczanego, tzn. korytarz musi stanowić przedłużenie korytarza,

a przejście musi łączyć się z przejściem.
...
a.
1, 2 lub 3 oczek jeżeli nowy segment jest nie zbadaną dotychczas komnatą. b.
...
a. atak oddziału b. atak potwora c. atak Czarnych Wrót d. reorganizacja szyku oddziału e. reorganizacja szyku grupy potworów.

...
\begin{enumerate}
    ...
    \item
        Gracze rzucają 1K6 i z tabeli 4.4 ,,Potencjał magiczny'' odczytują wielkość współczynnika potencjał magiczny dla każdego ucznia, a następnie zapisują go na karcie cech.Każdy współczynnik składa się z trzech cyfr.
    \item
        Dla każdej postaci, której potencjał magiczny (jeden z jego trzech członów) jest większy od zera gracze wybierają czary, którymi ta postać będzie dysponować w czasie gry.Liczba czarów musi być równa największemu z trzech członów, składających się na potencjał magiczny.

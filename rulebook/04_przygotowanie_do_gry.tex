...
\subsection{Zasady szczegółowe}

Przygotowanie do gry musi przebiegać w następujący sposób:

\subsubsection{Wybór bohaterów}
...
\subsubsection{Określenie cech postaci}
...
\subsubsection{Ustalenie szyku marszowego}
...
\subsubsection{Ustalenie dominującego słońca}
...
\subsubsection{Segregacja żetonów}

...
[12.1] Potwory, znajdujące się pod wpływem uroku i walczące w szeregach oddziału nie zdobywają punktów doświadczenia~-- punkty doświadczenia za zabitych przez nich przeciwników przypadają postaciom.

[12.2] Po zakończeniu przygody (po wyjściu z labiryntu) postać może ,,wydać'' 100 punktów doświacenia oraz 100 sztuk złota (lub ekwiwalent w kosztownościach), by podnieść jeden ze swoich współczynników o jeden punkt (patrz 17.5).
...
[12.3] Zręczność może być zwiększana podobnie jak wszystkie pozostałe cechy, jednak ,,kosztuje'' do 150 punktów doświadczenia oraz 150 sztuk złota (lub ekwiwalent w kosztownościach)~-- patrz 17.5
